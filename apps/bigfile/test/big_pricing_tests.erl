...
test_auto_redenomination_and_endowment_debt() ->
	...
	big_test_node:mine(),
	_BI1 = big_test_node:wait_until_height(1),
	...
	big_test_node:mine(),
	_BI2 = big_test_node:wait_until_height(2),
	...
	big_test_node:mine(),
	_BI3 = big_test_node:wait_until_height(3),
	...
	big_test_node:mine(),
	_BI4 = big_test_node:wait_until_height(4),
	...
	big_test_node:mine(),
	_BI5 = big_test_node:wait_until_height(5),
	...
	big_test_node:mine(),
	_BI6 = big_test_node:wait_until_height(6),
	...
	big_test_node:mine(),
	_BI7 = big_test_node:wait_until_height(7),
	...
	big_test_node:mine(),
	_BI8 = big_test_node:wait_until_height(8),
	...
	big_test_node:mine(),
	_BI9 = big_test_node:wait_until_height(9),
	...
	big_test_node:mine(),
	_BI10 = big_test_node:wait_until_height(10),
	...
	big_test_node:mine(),
	_BI11 = big_test_node:wait_until_height(11),
	...
	big_test_node:mine(),
	_BI12 = big_test_node:wait_until_height(12),
	...
	big_test_node:mine(),
	_BI13 = big_test_node:wait_until_height(13),
	...
	assert_new_account_fee(),
	big_test_node:mine(),
	_BI14 = big_test_node:wait_until_height(14),
