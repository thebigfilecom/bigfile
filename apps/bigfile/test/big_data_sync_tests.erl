...
test_syncs_after_joining(Split) ->
	Wallet = big_test_data_sync:setup_nodes(),
	{TX1, Chunks1} = big_test_data_sync:tx(Wallet, {Split, 17}, v2, ?BIG(1)),
	...
	{MainTX2, MainChunks2} = big_test_data_sync:tx(Wallet, {Split, 13}, v2, ?BIG(1)),
	...
	{MainTX3, MainChunks3} = big_test_data_sync:tx(Wallet, {Split, 12}, v2, ?BIG(1)),
	...
	{PeerTX2, PeerChunks2} = big_test_data_sync:tx(Wallet, {Split, 20}, v2, ?BIG(1)),
