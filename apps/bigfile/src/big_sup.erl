...
init([]) ->
	...
	ets:new(big_tx_emitter_recently_emitted, [set, public, named_table]),
	...
	Children = [
		...
		?CHILD_SUP(big_nonce_limiter_server_sup, supervisor),
		?CHILD(big_nonce_limiter, worker),
		?CHILD_SUP(big_nonce_limiter_client, worker),
